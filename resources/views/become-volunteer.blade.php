...
@section('page-content')    
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">  
                        <div class="mb-3">
                            ...
                            <div class="d-flex">
                            <!-- <input class="form-control flex-1" type="text" id="countryCode" name="countryCode" placeholder="country code"> -->
                            <input type="tel" class="form-control flex-3" id="phone">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- <script>
        // JSON data containing country codes
        const countryCodes = {
        ...
        // Add an event listener to update the country code and phone fields when a country is selected
        ...
        // Add an event listener to update the selected country when a country code is input
        countryCodeInput.addEventListener("input", function () {
            const inputCountryCode = countryCodeInput.value;
            const selectedCountry = Object.keys(countryCodes).find(
                (key) => countryCodes[key] === inputCountryCode
            );
            ...
            if (selectedCountry) {
                ...
                countrySelect.value = ""; // Clear the selection if the code doesn't match any country
            }
        });
