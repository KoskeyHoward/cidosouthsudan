...
<body>
        ...
        <main class="programs-main p-4 pt-0 ">
            <div class="card pt-3 pb-2 mb-0 mt-0">
                ...
                <div class="top ">
                    <div>
                        ...
                        <div class="p-2 ps-0">
                            <p> Show 
                                <select id="rowCount">
                                    <option value="{{$programCount}}"> All</option>
                ...
                <!-- <div class="page-numbers">
                    <p>Showing <span id="displayRange" class="pagination-link"></span>  of {{$programCount}} entries</p>
                </div> -->
    ...
    <script>
        ...
        //     let totalVisibleRows = document.querySelectorAll('.activities-table tbody tr').length; 
