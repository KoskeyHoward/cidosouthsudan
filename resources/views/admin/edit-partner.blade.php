    ...
    <header  id="head">
        <div class="header-left">
            ...
            <div class=" text-light p-4 pt-5">
                <h3>Partner</h3>
                <p><a href="/dashboard" style="color: #BFC7F4;">Dashboard / </a><a href="/dash-partners" style="color: #BFC7F4;">Partners /</a><a href="{{url('edit-partner/'.$Partners->id)}}" class="text-light"> Edit-Profile</a></p>
            </div>
        </div>
        <!-- profile  -->
    ...
    <div class="content">
        ...
        <main class="programs-main p-4 pt-0">
            <div class="card " style="border: none;">
                ...
                @endif
                <div class="p-3 pt-0">                    
                    <form action="{{url('update-partner/'.$Partners->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf 
                        @method('PUT') 
                        <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            <label class="mb-2 fw-bold" for=""> Name</label>
                            <input type="text" name="name" value="{{ $Partners->name }}" class="form-control">
                        </div>
                        <div class="col-md-6 form-group mb-3">
                            <label class="mb-2 fw-bold" for=""> Email</label>
                            <input type="email" name="email" value="{{ $Partners->email }}" class="form-control">
                        </div>
                        </div>
                        
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                <label class="mb-2 fw-bold" for=""> link</label>
                                <input type="text" name="link" value="{{ $Partners->link }}"  class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <img class="mt-2 " src="{{asset('images/Partners/'.$Partners->partner_image)}}" width="100px" height="100px" alt="partner-image">
                        </div>
