    ...
    <header  id="head">
        <div class="header-left">
            ...
            <div class=" text-light p-4 pt-5">
                <h3>Profile</h3>
                <p><a href="/dashboard" style="color: #BFC7F4;">Dashboard / </a><a href="/dash-volunteers" style="color: #BFC7F4;">Volunteers /</a><a href="{{url('edit-volunteer/'.$volunteer->id)}}" class="text-light"> Edit-Profile</a></p>
            </div>
        </div>
        <!-- profile  -->
    ...
    <div class="content">
        ...
        <main class="programs-main p-4 pt-0">
            <div class="card " style="border: none;">
                ...
                @endif
                <div class="p-3 pt-0">                    
                    <form action="{{url('update-volunteer/'.$volunteer->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf 
                        @method('PUT') 
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select id="gender" name="gender" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        <option value="{{ $volunteer->gender }}" disabled selected class="text-secondary">Select Gender</option>    
                            ...
                            <div class="col-lg-6">  
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <input type="tel" name="phone_number" value="{{ $volunteer->phone_number }}" class="form-control flex-3" id="phone_number"> 
                                    </div>                           
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="profession" value="{{ $volunteer->profession }}"  class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class=" col-md-4 form-group mb-3">
                                <label class="mb-2 fw-bold" for=""> Facebook url</label>
                                <input type="text" name="facebook" value="{{ $volunteer->facebook }}"  class="form-control">
                            </div>
                            <div class=" col-md-4 form-group mb-3">
                                <label class="mb-2 fw-bold" for=""> Instagram url</label>
                                <input type="text" name="instagram" value="{{ $volunteer->instagram }}"  class="form-control">
                            </div>
                            <div class="col-md-4 form-group mb-3">
                                <label class="mb-2 fw-bold" for=""> X url</label>
                                <input type="text" name="twitter" value="{{ $volunteer->twitter }}"  class="form-control">
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <label class="mb-2 fw-bold" for=""> Image</label>
                            <input type="file" name="user_image" class="form-control">
                            <img class="mt-2 " src="{{asset('images/volunteers/'.$volunteer->volunteer_image)}}" width="100px" height="100px" alt="volunteer-image">
                        </div>
